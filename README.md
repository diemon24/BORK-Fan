# Делаем вентилятор BORK умным и интегрируем в Home Assistant
...
Перед тем как модернизировать вентилятор в "умный" я ставил перед собой задачу не только оставить текущий функционал, но и дополнить его - вентилятор должен уметь работать без интеграции с HomeAssistant. Но и сама интеграция с моим умным домом позволит расширить возможности вентилятора. 
...
<img width="403" alt="image" src="https://github.com/user-attachments/assets/6ccd54ef-f9d7-4e01-9a85-363c4617132d" />
